...
public class PersonaConverter implements Converter, Serializable {
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String value) {
		...
		try {
			...
			logger.debug("[PersonaConv]-ListaPersonas: "+personas.size());
			/*for (int i = 0; i < personas.size(); i++) {
				logger.debug("ConverterPersona-> "+personas.get(i).getIdPersona()+" "+personas.get(i).getNumeroDocumento()+
						personas.get(i).getNombreCompleto());
			}*/
